...
const std::string Level5::stateID = "LEVEL5";

Level5::Level5(){}

bool Level5::OnEnter() {
	std::cout << "Entering Level5!\n";
	...
	if (!map->Load("Resources\\Maps\\Level5.txt", ResourceLoader::meshes, ResourceLoader::shaders[SHADER::TILE], ResourceLoader::textures[TEXTURE::PALETTE])) {
		return false;
	}
	...
	fire->SetPosition(glm::vec3{ 17.5f, 1.0f, -1.9f });
...
bool Level5::OnExit()
{
	std::cout << "Exiting Level5!\n";
	return true;
}

void Level5::HandleEvents(const SDL_Event &ev) {
