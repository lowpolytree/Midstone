...
bool GameOver::OnEnter()
{
	...
	buttons.push_back(std::make_shared<Button>(Position{ 1280 / 2, 250 }, Size{ 256.0f, 68.0f }, "REPLAY", std::make_unique<ReplayCommand>()));
	buttons.push_back(std::make_shared<Button>(Position{ 1280 / 2, 150 }, Size{ 256.0f, 68.0f }, "QUIT", std::make_unique<QuitCommand>()));

	background = std::make_unique<Image>(0.0f, 0.0f, 1280.0f, 720.0f, ResourceLoader::textures[TEXTURE::UI_GAMEOVER]);
